...
Hence deflecting torque, <span class="fontCss3">T<sub>d</sub> = G</span><span class="fontCss2"> i</span> ...(4)<br/>

where <span class="fontCss2">G = NBA = NB</span><span class="fontCss2">lr</span> ...(5)<br/>
...
$$d = 1000 \times 2 \theta_F = 2000 \ \frac{Gi}{K} \ mm ...(7)$$
...
where <span class="fontCss3">G</span> is the displacement constant of the galvanometer and is equal to <span class="fontCss3">NB</span><span class="fontCss2">lr</span>. The units of <span class="fontCss3">G</span> are Nm/A.<br/>
...
where, <span class="fontCss3">J</span> = Moment of inertia of moving system about the axis of rotation, kg-m<sup>2</sup><br/>
...
The auxiliary equation of the differential equation (Eqn. 10) is obtained as,
