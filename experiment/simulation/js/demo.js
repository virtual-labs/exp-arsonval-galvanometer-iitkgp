...
jsPlumb.ready(function () {
    ...
    instance.batch(function () {
      ...
      document.getElementById("check").addEventListener("click", function () {
        ...
        var actual_connections = instance.getAllConnections();
				...
				var is_connected_14_23 = false;
				var is_connected_7_22 = false;
				var is_connected_15_7 = false;
				var is_connected_23_6 = false;
        ...
        actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_9_17){
                is_connected_9_17 = correct_connections_9_17.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
	...
	actual_connections.forEach(function (connection) {
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_14_23){
                is_connected_14_23 = correct_connections_14_23.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_15_7){
                is_connected_15_7 = correct_connections_15_7.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
		...
		actual_connections.forEach(function (connection) {
            ...
            if(!is_connected_23_6){
                is_connected_23_6 = correct_connections_23_6.find(function (conn) {
                    return conn.source === this_connection.source && conn.target === this_connection.target;
                });
            }
              // if this_connection exists in correct_connections
